...
model_path = os.path.join(base_path, "advertising_model.pkl")
data_path = os.path.join(base_path, "Advertising.csv")
comp_path = os.path.join(base_path, "model_comparison.csv")
